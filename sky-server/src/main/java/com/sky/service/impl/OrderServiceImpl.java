...
// import com.sky.utils.WeChatPayUtil; // 已弃用
...
public class OrderServiceImpl implements OrderService {
    ...
    // @Autowired
    // private WeChatPayUtil weChatPayUtil; // 已弃用
...
//        支付状态
        ...
        if (payStatus == Orders.PAID) {
            // 本地流程：记录日志并视为已退款
            log.info("本地退款：订单号:{} 金额:{}", ordersDB.getNumber(), ordersDB.getAmount());
        }
...
//        支付状态
        ...
        if (payStatus == 1) {
            // 本地流程：记录日志并视为已退款
            log.info("本地退款：订单号:{} 金额:{}", orderDB.getNumber(), orderDB.getAmount());
        }
